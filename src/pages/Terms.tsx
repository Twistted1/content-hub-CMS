      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl text-foreground">{t('terms.navBrand')}</span>
          </Link>
        ...
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
            <p className="text-muted-foreground">
              {t('terms.lastUpdated')} {new Date().toLocaleDateString(i18n.language, { month: 'long', day: 'numeric', year: 'numeric' })}
            </p>
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                <a href={`mailto:${t('terms.contactEmail')}`} className="text-primary hover:underline">
